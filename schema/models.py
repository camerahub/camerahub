...
class Flash(models.Model):
  ...
  gn_info = models.CharField(help_text='Extra freeform info about how the guide number was measured', max_length=45, blank=True, null=True)
  battery_powered = models.BooleanField(help_text='Whether this flash takes batteries', blank=True, null=True)
  pc_sync = models.BooleanField(help_text='Whether the flash has a PC sync socket', blank=True, null=True)
  ...
  dslr_safe = models.BooleanField(help_text='Whether this flash is safe to use with a digital camera', blank=True, null=True)
  ttl = models.BooleanField(help_text='Whether this flash supports TTL metering', blank=True, null=True)
...
class LightMeter(models.Model):
  ...
  min_asa = models.IntegerField(help_text='Minimum ISO/ASA that this meter is capable of handling', blank=True, null=True)
  max_asa = models.IntegerField(help_text='Maximum ISO/ASA that this meter is capable of handling', blank=True, null=True)
  min_lv = models.IntegerField(help_text='Minimum light value (LV/EV) that this meter is capable of handling', blank=True, null=True)
  max_lv = models.IntegerField(help_text='Maximum light value (LV/EV) that this meter is capable of handling', blank=True, null=True)
  def __str__(self):
    if self.manufacturer is not None:
      return "%s %s" % (self.manufacturer.name, self.model)
    else:
...
class FilmStock(models.Model):
  ...
  manufacturer = models.ForeignKey(Manufacturer, on_delete=models.CASCADE, blank=True, null=True)
  iso = models.IntegerField(help_text='Nominal ISO speed of the film', blank=True, null=True)
...
class LensModel(models.Model):
  ...
  nominal_min_angle_diag = models.IntegerField(help_text='Nominal minimum diagonal field of view from manufacturer specs', blank=True, null=True)
  nominal_max_angle_diag = models.IntegerField(help_text='Nominal maximum diagonal field of view from manufacturer specs', blank=True, null=True)
...
class CameraModel(models.Model):
  ...
  min_iso = models.IntegerField(help_text='Minimum ISO the camera will accept for metering', blank=True, null=True)
  max_iso = models.IntegerField(help_text='Maximum ISO the camera will accept for metering', blank=True, null=True)
  af_points = models.IntegerField(help_text='Number of autofocus points', blank=True, null=True)
  int_flash = models.BooleanField(help_text='Whether the camera has an integrated flash', blank=True, null=True)
  int_flash_gn = models.IntegerField(help_text='Guide number of internal flash', blank=True, null=True)
  ext_flash = models.BooleanField(help_text=' Whether the camera supports an external flash', blank=True, null=True)
  flash_metering = models.ForeignKey(FlashProtocol, on_delete=models.CASCADE, blank=True, null=True)
  pc_sync = models.BooleanField(help_text='Whether the camera has a PC sync socket for flash', blank=True, null=True)
  ...
  meter_min_ev = models.IntegerField(help_text='Lowest EV/LV the built-in meter supports', blank=True, null=True)
  meter_max_ev = models.IntegerField(help_text='Highest EV/LV the built-in meter supports', blank=True, null=True)
  dof_preview = models.BooleanField(help_text='Whether the camera has depth of field preview', blank=True, null=True)
...
class Movie(models.Model):
  ...
  fps = models.IntegerField(help_text='Frame rate of this movie, in fps', blank=True, null=True)
