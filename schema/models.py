...
# ) COMMENT='Table to catalog camera models - both cameras with fixed lenses and cameras with interchangeable lenses';
...
# ) COMMENT='Table to catalog cameras - both cameras with fixed lenses and cameras with interchangeable lenses';
...
#   `frame` varchar(5) CHARACTER SET utf8mb4 'Frame number or code of this negative',
#   `description` varchar(145) CHARACTER SET utf8mb4 'Caption of this picture',
#   `date` datetime 'Date & time on which this picture was taken',
#   `lens_id` int(11) 'ID of lens used to take this picture',
#   `shutter_speed` varchar(45) CHARACTER SET latin1 'Shutter speed used to take this picture',
...
#   `series_id` int(11) 'ID of the series to which this camera model or lens model belongs',
#   `cameramodel_id` int(11) 'ID of the camera model',
#   `lensmodel_id` int(11) 'ID of the lens model',
...
#   `name` varchar(45) 'Name of this collection, e.g. Canon FD SLRs',
