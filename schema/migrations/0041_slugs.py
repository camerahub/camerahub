...
def addToner(apps, schema_editor):
    ...
    custom_slugify_unique = UniqueSlugify(to_lower=True)
    for record in ExistingRecords.objects.all():
        record.slug = custom_slugify_unique("{} {}".format(record.manufacturer.name, record.name))
        record.save()
...
def addLensmodel(apps, schema_editor):
    ...
    custom_slugify_unique = UniqueSlugify(to_lower=True)
    for record in ExistingRecords.objects.all():
        record.slug = custom_slugify_unique("{} {} {}".format(record.manufacturer.name, record.model, str(record.disambiguation or '')))
        record.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(addManufacturer, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(addBattery, reverse_code=migrations.RunPython.noop),
        ...
        migrations.RunPython(addFilmstock, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(addDeveloper, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(addLensmodel, reverse_code=migrations.RunPython.noop),
    ]
